...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
       ...
       ,
        ...
        public static Flight flight5 = new Flight { FlightDate = new DateTime(2022, 05, 01, 17, 10, 10), Destination = "Madrid", EffectiveArrival = new DateTime(2022, 05, 01, 18, 50, 10), EstimatedDuration = 125, Plane = BoingPlane };
